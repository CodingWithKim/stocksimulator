...
public class createCompanyReportB {
    @FXML
    private ImageView revenueImage;

    @FXML
    private ImageView chartBImage;
    ...
    public void initialize(){
        ...
        Image image1 = new Image(getClass().getResourceAsStream("/Image/chartB.jpeg"));
        chartBImage.setImage(image1);
