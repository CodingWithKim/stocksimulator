...
public class createCompanyAnnualReportA {
    @FXML
    private ImageView revenueImage;

    @FXML
    private ImageView chartAImage;
    ...
    public void initialize(){
        ...
        Image image1 = new Image(getClass().getResourceAsStream("/Image/ChartA.jpeg"));
        chartAImage.setImage(image1);
