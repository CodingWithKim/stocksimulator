...
public class createCompanyReportC {
    @FXML
    private ImageView revenueImage;

    @FXML
    private ImageView chartCImage;
    ...
    public void initialize(){
        ...
        Image image1 = new Image(getClass().getResourceAsStream("/Image/chartC.png"));
        chartCImage.setImage(image1);
